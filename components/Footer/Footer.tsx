        ...
        <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="https://ai-ra.vercel.app/" className="hover:text-blue-400 transition-colors">
                  G-Nayana - Healthcare.AI
                </Link>
              </li>
              <li>
                <Link href="/Products#mi-ware" className="hover:text-blue-400 transition-colors">
                Mi-Ware - Integrations
                </Link>
              </li>
              <li>
                <Link href="/Products#i-hrms" className="hover:text-blue-400 transition-colors">
                  i-HRMS.AI
                </Link>
              </li>
              <li>
                <Link href="/Products/#ogcom-elp" className="hover:text-blue-400 transition-colors">
                LMS.AI
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/Resources/case-studies" className="hover:text-blue-400 transition-colors">
                  Case Studies
                </Link>
              </li>
              <li>
                <Link href="/Resources/whitepapers" className="hover:text-blue-400 transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/Resources/docs" className="hover:text-blue-400 transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
