      ...
      dropdown: [
...

        {
          ...
          items: [
            ...
            { name: "Cloud Migration Services", description: "Cloud Migration and Modernization ", icon: "/assets/Cloud-Services/internet-cloud-migration.png", href: "/Services/Oracle#oracle-fusion-cloud" },
